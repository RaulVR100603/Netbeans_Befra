 ...
 * @author HP
 */
@WebServlet(name = "rdatos", urlPatterns = {"/rdatos"})
public class rdatos extends HttpServlet {
 ...
 public String insertar(String agregarusuario)
    {
        String html="";
        try{
            ...
            int fila=a.executeUpdate(agregarusuario);
            return html+=fila+"usuario registrado";
        }
        catch(SQLException base)
        {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String agregarusuario="insert into datos(usuario , unidad , ubicacion ,destino , horario) values('"+usuario+"','"+unidad+"','"+ubicacion+"','"+destino+"','"+horario+"')";
            ...
            out.println(""+insertar(agregarusuario));
